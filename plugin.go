...
:root {
  ...
  --pico-primary: #e94560;
  --pico-primary-hover: #c73650;
  --pico-primary-focus: rgba(233, 69, 96, 0.25);
  --pico-primary-inverse: #fff;
  --pico-primary-background: #e94560;
  --pico-primary-background-hover: #c73650;
  --pico-primary-underline: rgba(233, 69, 96, 0.5);
  --gc-accent: #e94560;
  --gc-accent-hover: #c73650;
  --gc-danger: #ff6b7a;
...
.category-tab:active { opacity: 0.7; }
...
.action-card:active { background: var(--pico-card-sectioning-background-color); }
.action-card.active { border-color: var(--gc-accent); background: var(--pico-card-sectioning-background-color); }

.action-card.danger { color: var(--gc-danger); }
.action-card.danger.active { border-color: var(--gc-danger); background: var(--gc-danger-bg); }
...
.target-btn:active { border-color: var(--gc-accent); background: var(--pico-card-sectioning-background-color); }
...
.svc-chip:active { border-color: var(--gc-accent); }
...
.history-toolbar button:active { opacity: 0.7; }
...
<header class="gc-header">
  <div class="gc-header-inner">
    <a href="/" class="gc-back" title="Back to Gotify" aria-label="Back to Gotify">
      ...
      <h1><img src="data:image/png;base64," alt="" style="width:28px;height:28px;vertical-align:middle;border-radius:6px;"> Gotify Commander</h1>
